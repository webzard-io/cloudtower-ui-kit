...
describe("getFaultToleranceTime", () => {
  it("h2 be 120 * 1000", () => {
    ...
    expect(h2).toMatchInlineSnapshot("120000");
  });
  it("h24 be 10 * 60 * 1000", () => {
    ...
    expect(h24).toMatchInlineSnapshot("600000");
  });
  it("d7 be 60 * 60 * 1000", () => {
    const dateRange: DateRange = [
      dayjs("2022-12-13 16:00"),
    ...
    expect(d7).toMatchInlineSnapshot("3600000");
  });
  it("d30 be 60 * 60 * 1000", () => {
    ...
    expect(d30).toMatchInlineSnapshot("3600000");
  });
  it("d182 be 24 * 60 * 60 * 1000", () => {
    ...
    expect(d182).toMatchInlineSnapshot("86400000");
  });
  it("d188 be 120 * 1000", () => {
    const dateRange: DateRange = [
      dayjs("2022-12-13 16:00"),
    ...
    expect(d188).toMatchInlineSnapshot("120000");
  });
});
...
describe("getFirstExpectedTimestamp", () => {
  it("firstShouldbe 1670918407000", () => {
    ...
    expect(firsExpectedTimestamp).toMatchInlineSnapshot("1670918407000");
  });
});
