...
import {
  ...
  EverouteCluster,
  GetAllRecycleBinSettingsQuery,
  GetEverouteClustersQuery,
  GetVmInfoQuery,
  GetVmsForMigrationQuery,
  GetVmsInRecycleBinQuery,
  GraphCreateInput,
  GraphsQuery,
  Hypervisor,
  ListEntityFilterQuery,
  Maybe,
  NetworkType,
  NicDriverState,
  NtpMode,
...
import {
  ...
  PanelOptions,
  RackTopo,
} from "../modules/hardware-topo/types";
...
export type ModalProps = {
  ConnectClusterWizard: { datacenterId?: string };
  EditClusterModal: {
    clusterId: string;
  };
  DeleteClusterModal: {
    cluster: {
      ...
      vms?: Maybe<
        Array<Pick<Vm, "id" | "name" | "vm_usage" | "in_recycle_bin">>
      >;
    };
  };
  DeleteClusterDisabledModal: {
    ...
    cloudTowerSystemVms:
      | Pick<Vm, "vm_usage" | "id" | "in_recycle_bin" | "name">[]
      | undefined;
    clusterName: string | undefined;
  };
  RebootVmModal: { vm: { id: string; name: string }; force?: boolean };
  BatchRebootVmModal: {
  ...
  DeleteVmVolumeModal: { vmVolume: { id: string; name: string } };
  BatchDeleteVmVolumeModal: {
    vmVolumes: {
      id: string;
      name: string;
      cluster: { connect_state: ConnectState };
      vm_disks?:
        | {
            id: string;
            vm: {
  ...
  BatchDeleteFailedVmVolumeModal: {
    canNotArr: { id: string; name: string; result: string[] }[];
  };
  CreateVm: {
    where?: {
  ...
  EditVmModal: { vmId: string };
  EditVmOwnerModal: { vmId: string };
  ...
  EditVmDiskModal: { vmId: string };
  CreateVdsModal: { id: string };
  EditVdsModal: { id: string; clusterId: string };
  DeleteVdsModal: {
    id: string;
    name: string;
    type: NetworkType;
  ...
  CreateVmVolumeModal: { id: string };
  CreateVlanModal: { id: string };
  EditVlanModal: { id: string };
  EditMigrationVlanModal: { id: string };
  DeleteVlanModal: { id: string; clusterId: string };
  DiskUnmountModal: { id: string };
  DiskMountModal: { id: string };
  RegionUnmountModal: { id: string };
  RegionMountModal: { id: string };
  EditHostNameModal: { vmId: string };
  EditDnsModal: { vmId: string };
  EditNtpModal: { vmId: string };
  EditGuestAccountModal: { vmId: string };
  CreateDatacenterModal: void;
  EditDatacenterModal: { id: string };
  DeleteDatacenterModal: { id: string; name: string };
  EditVmNicModal: { id: string; clusterId?: string };
  CreateVmFolderModal: { id: string };
  RenameVmFolderModal: { id: string; name: string; clusterId?: string };
  DeleteVmFolderModal: { id: string };
  ...
  RemoveFromFolderModal: { id: string; name: string; folderName: string };
  BatchRemoveFromFolderModal: {
    vms: OperationVmsRecord[];
  };
  EditNicMTUModal: { id: string; mtu: number };
  CloneVmWizard: {
    id: string;
  };
  RollbackVm: { vmSnapshotId: string; vmId: string };
  CreateVmSnapshotModal: { vmId: string };
  EditVmSnapshotModal: {
    id: string;
    name: string;
  ...
  VmSnapshotDetailModal: { id: string };
  DeleteVmSnapshotModal: { id: string; name: string; size: number };
  ConvertVmByVmTemplateModal: { id: string; name?: string };
  CreateVmTemplateByVmModal: { id: string };
  CannotCreateVmTemplateByVmModal: { id: string };
  CloneVmAsVmTemplateModal: { id: string };
  CreateElfImageModal: { resourceId: string; resource: string };
  EditElfImageModal: { id: string; name: string; description: string };
  DeleteElfImageModal: { id: string };
  EditClusterName: { cluster: { id: string; name: string } };
  ...
  CreateViewModal: {
    clusterId?: string;
    view?: { id: string; name: string; time_span: number; time_unit: TimeUnit };
  };
  CreateGraphModal: {
    viewId: string;
    clusterId: string;
  ...
  DeleteViewModal: { view: { id: string; name: string } };
  DeleteGraphModal: { graph: { id: string; title: string } };
  EditVmCpuModel: {
    vm: {
      id: string;
      name: string;
  ...
  DeleteIscsiTargetModal: {
    iscsiTarget: { id: string; name: string };
  };
  CreateIscsiLunModal: {
    iscsiTargetId: string;
  };
  ...
  DeleteIscsiLunModal: {
    iscsiLun: { id: string; name: string };
  };
  CreateIscsiLunSnapshotModal: {
    iscsiLun: { iscsiLunId: string; iscsiTargetId: string; lunName: string };
  };
  ...
  RollbackLunSnapshot: {
    iscsiLunSnapshot: { snapshotId: string; snapshotName: string };
  };
  ...
  DeleteNfsExportModal: {
    nfsExport: { id: string; name: string };
  };
  ...
  EditUserModal: { id: string };
  DeleteUserModal: { id: string; username: string };
  ...
  UpdateApplicationModal: { id: string };
  StopApplicationModal: { id: string; name: string };
  DeleteReportTaskModal: { id: string; name: string };
  ...
  CreateSnapshotPlanModal: { clusterId?: string };
  UpdateSnapshotPlanModal: { id: string };
  SnapshotPlanInfoTab: {
    id: string;
  };
  ExecutePlan: {
  ...
  CreateVmPlacementGroupModal: { id: string };
  ...
  EditManagementVlanModal: { id: string };
  AboutModal: void;
  ...
  TableExportModal: {
    tableName?: string;
    dynamicExtraColumns?: { title: string; idx: number }[];
    source?: string;
  };
  ...
  EditBackupPlanObjectModal: { id: string };
  EditBackupPlanPeriodModal: { id: string };
  EditBackupPlanPolicyModal: { id: string };
  StopDistributeImageModal: { distributeName: string; taskId: string };
  StopDistributeVmTemplateModal: { distributeName: string; taskId: string };
  DistributeTaskDetailModal: { taskId: string };
  UploadDetailModal: {
  ...
  RestoreVmModal: { id: string; backup_plan_id: string };
  DeleteRestorePoint: { id: string };
  ...
  CreateSecurityGroupModal: {
    ...
    onCreated?: (
      id: string,
      securityGroup: CreateSecurityGroupMutation["createSecurityGroup"]
    ) => void;
  };
