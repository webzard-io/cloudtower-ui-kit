import {
  ArrowChevronDown16BlueIcon as ArrowDown,
  ArrowChevronDown16BoldBlueIcon as ArrowDownBold,
  ArrowChevronDownSmall16BlueIcon as ArrowDownSmall,
...
const TabMenu: React.FC<TabMenuProps> = (props) => {
  ...
  return (
    ...
    >
            ...
            return (
              <AntdDropdown
                ...
                overlay={
                  ...
                  >
                    {tab.items?.map((item) => (
                      <AntdMenu.Item data-test={item.key} key={item.key}>
                        {item.title}
                      </AntdMenu.Item>
                    ))}
                  </AntdMenu>
      ...
      <div key={selectedKey} className="tab-content">
        {renderTabContent()}
      </div>
    </div>
  );
