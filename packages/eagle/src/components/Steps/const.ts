...
const VERTICAL_STEP_WIDTH = 138;

// 由于纵向模式是定宽，所以可以直接计算纵向模式下文字区域最大宽度
const VERTICAL_MAX_TEXT_WIDTH =
  VERTICAL_STEP_WIDTH - VERTICAL_PADDING * 2 - PREFIX_GAP - STEP_PREFIX_WIDTH;
