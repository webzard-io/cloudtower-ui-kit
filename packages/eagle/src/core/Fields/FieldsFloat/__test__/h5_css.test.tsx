...
import FieldsFloat from "..";

describe("FieldsFloat h5_css", () => {
  it("h5_css", ({ expect }) => {
    ...
    expect({
      ...
      ,
        ...
        .ant-input-number-input-wrap::after {
          content: var(--agis2c2-1);
          display: var(--agis2c2-2);
          flex: none;
          align-items: center;
          margin-left: 4px;
        }
        ...
        .ant-input-number-input-wrap::before {
          content: var(--agis2c2-3);
          display: var(--agis2c2-4);
          flex: none;
          align-items: center;
          margin-right: 4px;
          cursor: auto;
        ...
        .ant-input-number-input {
          ...
          style=--agis2c2-0:,initial;,--agis2c2-1:,"";,--agis2c2-2:,none;,--agis2c2-3:,"";,--agis2c2-4:,none;
        >
          <div
