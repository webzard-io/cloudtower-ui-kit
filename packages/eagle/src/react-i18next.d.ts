declare module "react-i18next" {
  ...
  export function Trans<E extends Element = HTMLDivElement>(
    props: TransProps<E>
  ): React.ReactElement;
  ...
  export function withTranslation(
    ...
    C extends React.ComponentType<
      React.ComponentProps<C> & WithTranslationProps
    >,
  ...
  >(
    ...
    Omit<ResolvedProps, keyof WithTranslation> & WithTranslationProps
  >;
